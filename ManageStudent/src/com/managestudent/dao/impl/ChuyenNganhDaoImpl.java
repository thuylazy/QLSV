...
public class ChuyenNganhDaoImpl extends BaseDaoImpl implements ChuyenNganhDao {
	...
	/* (non-Javadoc)
	 * @see managestudent.dao.ChuyenNganhDao#getTotalRecords(managestudent.entities.ChuyenNganh)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see managestudent.dao.ChuyenNganhDao#updateChuyenNganhByMaChuyenNganh(int, managestudent.entities.ChuyenNganh)
	 */
	@Override
